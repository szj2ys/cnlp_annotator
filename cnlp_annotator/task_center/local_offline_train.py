...
You can run shell command below at root dir of project:
   python -m cnlp_annotator.task_center.local_offline_train -c ./tests/data/test_config.json
...
from cnlp_annotator.algo_factory.components import ComponentBuilder
from cnlp_annotator.task_center.data_loader import load_local_data
from cnlp_annotator.task_center.model import Interpreter
from cnlp_annotator.task_center.model import Trainer

from cnlp_annotator.task_center.config import AnnotatorConfig
